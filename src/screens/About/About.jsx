...
const About = () => {
  return (
    <Layout>
    <div className="home">
        <img className="avatar" src="https://i.imgur.com/Gs7Iu7m.png" alt-img=" " />
